...
namespace SpeckleRhinoMappings
{
  ...
  ///</summary>
  public class SpeckleRhinoMappingsPlugin : Rhino.PlugIns.PlugIn
  {
    private WV2DockBar WV2DockBar;

    public SpeckleRhinoMappingsPlugin()
    {
      Instance = this;
    }

    public static SpeckleRhinoMappingsPlugin Instance { get; private set; }
  ...
  public class WV2DockBar : DockBar
  {
    ...
    public static Guid BarId => new Guid("{24F0F026-C676-4BD3-BC06-71BDBD4A1668}");
    ...
    public WV2DockBar() : base(SpeckleRhinoMappingsPlugin.Instance, BarId, "WebView2")
    {
      if (DockPage == null)
      {
